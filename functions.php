	...
	if ( !function_exists('core_mods') ) {
		function core_mods() {
			if ( !is_admin() ) {
                ...
                wp_register_script('jquery.masonry', (get_template_directory_uri()."/js/jquery.masonry.min.js"),'jquery.masonry',false,true);
                wp_register_script('gridly.functions', (get_template_directory_uri()."/js/functions.js"),'gridly.functions',false,true);
